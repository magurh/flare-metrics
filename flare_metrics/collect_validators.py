...
def main():
    parser = argparse.ArgumentParser(description='Collect validator data.')
    parser.add_argument('source', type=str, help='Source for collecting validator data.')

    args = parser.parse_args()

    if args.source == 'flare-metrics':
        flare_metrics_validators()
    else:
        print(f'{args.source} not supported.')
        

def flare_metrics_validators():
    # Define paths
